...
<section class="bannerbottom py-lg-5 py-md-4 py-md-3 py-2"><CENTER><h2 STYLE="COLOR:BLUE">OUR SERVICES</h2></CENTER>
...
<div class="card" >
  ...
  <div class="card-body">
    ...
    <a href="checkinglog.php"><span style="color:blue;font-weight:bold"><u>APPLY NOW</u></span></a>
                        ...
                        <div class="loginf_module">
                            <div class="module form-module">
                                <div class="toggle">
                                    ...
                                    <div style="background-color:blue;color:white;passind:1%;"class="tooltip">click here for New Register</div>
                                </div>
                                <div class="form">
                                    ...
                                    <form action="login_action.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="submit" value="Login" onclick="return log()">
                                    </form>
                                    <div class="cta">
...
<br><br>
                                    ...
                                    <form action="Elogin_action.php" method="post" enctype="multipart/form-data">
                                        <input type="text" name="Eusername" placeholder="Username" id="Eusername"  >
                                        <input type="password" name="Epassword" placeholder="Password" id="Epassword"  >
                                        <input type="submit" value="Login" onclick="return Elogg()">
                                    </form>
                                    <div class="cta">
                                        <a href="#">Forgot password?</a>
                                    </div>
...
function Elogg(){   
    var En=document.getElementById("Eusername").value;
    var Ep=document.getElementById("Epassword").value;  
    
    if(En==""){
        alert("!!--Employee user name is empty please provide the username--!!");
        return false;
    }
    else if(Ep==""){
        alert("!!--Employee password is empty please provide the password--!!");
        return false;
    } 
    else{
        return true;
                                ...
                                <div class="form">
                                    <h3>New User - Create a new account</h3>
                                    <form action="register_action.php" method="post" enctype="multipart/form-data">
                                        <input type="text" name="username" placeholder="Username" id="usernames"  >
                                        <input type="password" name="password" placeholder="Password"  id="passwords"  >
                                        ...
                                        <input type="submit" value="Register" onclick="return reg()">
                                    </form>
                                </div>

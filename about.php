...
<nav class="navbar navbar-expand-lg navbar-light">
  <a class="navbar-brand" href="index.php">Fast Service</a>
...
<p class="mb-lg-4 mb-md-3 mb-sm-2 mb-2"> Since 2005 we establish our company in USA, within 10 years we establish our company in world wides. Now we have branches in UK,AUSTRALIA,INDIA,CANADA,RUSSIA... We provide best services to our customers with low cost and we gain our customers relablility.</p>
...
<div class="test-wel">
						...
						<ul>
							<li>
								<i class="fas fa-check"></i> experience works  </li>
							<li>
								<i class="fas fa-check"></i> low charges for the works</li>
							<li>
								<i class="fas fa-check"></i>quickly serives</li>
								<li>
								<i class="fas fa-check"></i>1000+ Interior designs</li> 
						</ul>
					</div>
</div>
...
<h5>we provide --></h5> <br>
						<ul>
							...
							<li>
								<i class="fas fa-check"></i>quickly serives</li> 
								<li> <i class="fas fa-check"></i>200+ Exterior Designs</li>
						</ul>
					</div>
</div>
...
<h5>we provide --></h5> <br>
						<ul>
							...
							<li>
								<i class="fas fa-check"></i>quickly serives</li> 
								<li> 	<i class="fas fa-check"></i>100+ high quality Eco-Grass</li> 
						</ul>
					</div>
</div>

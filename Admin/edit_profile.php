...
$id=$_SESSION['id'];
$res="select * from tb_admin where admin_id='$id'";
...
if($count>0){
	...
	?>
						...
						<input class="form-control" name="img_id" value="<?php echo $row['img_id'];  ?>" type="hidden" >
...
{
   echo "<script>reset();
alertify.alert('Profile Edited Successfully..');</script>";	
}
}
?>
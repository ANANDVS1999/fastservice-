            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-5 col-5">
                        <h4 class="page-title">View Enquiry Details</h4>
                    </div>
...
$res="select * from tb_allocateemployee"; 
...
while($row=$result->fetch_assoc()){
	...
	?>
                                        ...
                                        <td style="color:black"><?php echo $row['SERVICE_REQUEST'];  ?></</td>
                                        <td style="color:black"><?php echo $row['EMPLOYEE_NAME'];  ?></</td>  
										<td> <?php echo"<a style='color:red' onclick='javascript:confirmation($(this));return false;' href='remove_enquiry.php?id=".$row['ID']."'><button class='btn btn-danger btn-del3'>REMOVE</button></a>"?>  </td>
                                        <td>
  <?php
  if($row['STATUS']==2){
      echo " Rejected ";

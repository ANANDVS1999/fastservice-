                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form action="gallery_action.php"  method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
										<label>Image</label>
										<input class="form-control" name="pic"   id="fileupload" onchange="PreviewImage();" type="file" required>
									<img id="uploadPreview" src="" alt="" class="img-responsive" height="70" width="70" style="margin-left:50px;;">
									</div>
                                </div>
                                <!--<div class="col-md-6">
									<div class="form-group">
                            ...
                            <!--<div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Date</label>
                                        <div class="cal-icon">
                                            <input type="text" name="gal_date" class="form-control datetimepicker" >
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn">Add Gallery</button>
                            </div>
                        </form>
                    </div>
                </div>

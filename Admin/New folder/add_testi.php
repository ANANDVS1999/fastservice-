       ...
       <div class="dropdown mobile-user-menu float-right">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row" >
                    <div class="col-lg-8 offset-lg-2">
                        <form action="testi_action.php"  method="post" enctype="multipart/form-data">
                            <div class="row">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn">Add Testimonials</button>
                            </div>
                        </form>
                    </div>
                </div>
...
{
   echo "<script>reset();
alertify.alert('Testimonials Added Successfully..');</script>";	
}
}
?>
        ...
        <div class="header">
			<div class="header-left">
				<a href="dashboard.php" class="logo">
					<!--<img src="assets/img/logo.png" width="35" height="35" alt="">--> <span>PEP ADMIN</span>
				</a>
			</div>
       ...
       <div class="dropdown mobile-user-menu float-right">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row" >
                    <div class="col-lg-8 offset-lg-2">
                        <form action="pdf_file_action.php"  method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
										<label>File</label>
										<input class="form-control" name="pic" accept="image/*"   id="fileupload" onchange="PreviewImage();" type="file" required>
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn">Add Slider</button>
                            </div>
                        </form>
                    </div>
                </div>
...
if($_REQUEST['result']=='alreadt')
{
   echo "<script>reset();
alertify.alert('File already exists..');</script>";	
}
}
?>
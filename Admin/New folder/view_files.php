            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-5 col-5">
                        <h4 class="page-title">View Files Details</h4>
                    </div>
                    <div class="col-sm-7 col-7 text-right m-b-30">
                        <a href="add_files.php" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Add Files</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
...
while($row=$result->fetch_assoc()){
	?>
                                    <tr class="holiday-completed">
                                        <td><?php echo $i++;  ?></td>
                                        <td> <embed src="<?php echo 'pdf_files/'.$row['pdf_file'];  ?>" class="img-responsive" width="150" height="150" /></td>
                                       <td><a href="pdf_download.php?file=<?php echo $row['pdf_file'];?>">Download</a></td>
                                       
										<td><button class="btn btn-danger btn-del3" id="<?php echo $row['pdf_id']; ?>">Delete</button></td>
                                    </tr>
                           <?php
}
}
...
if($_REQUEST['result']=='file_success')
{
   echo "<script>reset();
alertify.alert('Files Added Successfully..');</script>";	
}
}

        ...
        <div class="header">
			<div class="header-left">
				<a href="index-2.html" class="logo">
					<!--<img src="assets/img/1.png" width="35" height="35" alt="">--> <span>PEP Construction</span>
				</a>
			</div>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-5 col-5">
                        <h4 class="page-title">View Slider Details</h4>
                    </div>
                    <div class="col-sm-7 col-7 text-right m-b-30">
                        <a href="add_files.php" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Add Slider</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
...
while($row=$result->fetch_assoc()){
	?>
                                    <tr class="holiday-completed">
                                        <td><?php echo $i++;  ?></td>
                                        <td><img src="<?php echo 'slider/'.$row['slider_img'];  ?>" class="img-responsive" width="75" height="75"></td>
 ...
 <script>
		 ...
		 if(confirm("Are you sure you want to delete this?"))
  {
       ...
       var $ele = $(this).parent().parent();
				   ...
				   $ele.fadeOut().remove();
		             reset();
                     alertify.alert('Slider Deleted Successfully..');
						//alert('kkk');
...
{
   echo "<script>reset();
alertify.alert('Slider Added Successfully..');</script>";	
}
}
?>
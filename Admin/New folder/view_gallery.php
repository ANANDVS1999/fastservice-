...
<head>
    ...
    <title>SIVA SAKTHI DRIVING SCHOOL CITY-ADMIN</title>
        ...
        <div class="header">
			<div class="header-left">
				<a href="index-2.html" class="logo">
					<!--<img src="assets/img/1.png" width="35" height="35" alt="">--> <span>SIVA SAKTHI DRIVING SCHOOL</span>
				</a>
			</div>
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
						...
						<li>
                            <a href="view_enquiry.php"><i class="fa fa-dashboard"></i> <span>View Enquiries</span></a>
                        </li>
						<!--<li>
...
<li class="submenu">
						...
						<!--<li class="submenu">
							<a href="#"><i class="fa fa-image"></i> <span> Slider </span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">	
								<li><a href="add_files.php">Add Slider</a></li>
								<li><a href="view_slider.php">View Slider</a></li>
							</ul>
						</li>-->
						
							<li class="submenu">
							<a href="#"><i class="fa fa-image"></i> <span> Testimonials </span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">	
								<li><a href="add_testi.php">Add Testimonials</a></li>
								<li><a href="view_testi.php">View Testimonials</a></li>
							</ul>
						</li>
						<!--<li class="submenu">
...
while($row=$result->fetch_assoc()){
	?>
                                    <tr class="holiday-completed">
                                        <td><?php echo $i++;  ?></td>
                                        <td><img src="<?php echo 'gallery/'.$row['img_file'];  ?>" class="img-responsive" width="75" height="75"></td>
                                        <td style="color:black"><?php echo $row['caption'];  ?></</td>
                                        <td style="color:black"><?php echo $row['date'];  ?></</td>
                                        <td><a href="edit_gallery.php?id=<?php echo $row['img_id'];  ?>"><button class="btn btn-success">Edit</button></a></td>
										<td><button class="btn btn-danger btn-del3" id="<?php echo $row['img_id']; ?>">Delete</button></td>
                                    </tr>
                           <?php
}
}

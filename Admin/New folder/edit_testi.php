        ...
        <div class="header">
			<div class="header-left">
				<a href="index-2.html" class="logo">
					<!--<img src="assets/img/logo.png" width="35" height="35" alt="">--> <span>SIVA SAKTHI DRIVING SCHOOL</span>
				</a>
			</div>
...
$id=$_REQUEST['id'];
$res="select * from tb_testimonial where testimonial_id='$id'";
...
if($count>0){
	...
	?>
                        <form action="edit_testi_action.php" method="post" enctype="multipart/form-data">
						<input class="form-control" name="img_id" value="<?php echo $row['testimonial_id'];  ?>" type="hidden" required>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="client_name" value="<?php echo $row['client_name'];  ?>" type="text" >
                                    </div>
                                </div>
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn">Edit Testimonial</button>
                            </div>
                        </form>
						<?php
}
